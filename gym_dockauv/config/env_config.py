...
TRAIN_CONFIG_remus = copy.deepcopy(BASE_CONFIG)
TRAIN_CONFIG_remus["title"] = "Training Run"
TRAIN_CONFIG_remus["save_path_folder"] = os.path.join(os.getcwd(), "logs")
"""
...
"""
TRAIN_CONFIG_remus["reward_factors"] = {
