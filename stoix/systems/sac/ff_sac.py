...
def learner_setup(
    ...
    config.system.action_minimum = float(env.action_spec().minimum.min())
    config.system.action_maximum = float(env.action_spec().maximum.max())
...
@hydra.main(config_path="../../configs", config_name="remus_v1_ff_sac.yaml", version_base="1.2")
