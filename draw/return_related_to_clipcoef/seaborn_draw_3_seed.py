...
##########################
data1 = pd.read_csv('../plot_demo_files/return_related_to_clipcoef/0301_clipRun groupscleanrl_tau:0.9clip:0.05.csv')
...
df['parameter'] = r"$\epsilon$=0.05"

#######################

##########################
data1 = pd.read_csv('../plot_demo_files/return_related_to_clipcoef/0301_clipRun groupscleanrl_tau:0.9clip:0.1.csv')
x1 = data1.iloc[:, 0].values
x1 = data1.iloc[:, 0].values[: len(x1) // 3 * 3]
x1_0 = x1[0::3]
y1_0 = np.zeros(len(x1_0))
...
df_['parameter'] = r"$\epsilon$=0.1"
df = df.append(df_)
#######################

##########################
data1 = pd.read_csv('../plot_demo_files/return_related_to_clipcoef/0301_clipRun groupscleanrl_tau:0.9clip:0.15.csv')
x1 = data1.iloc[:, 0].values
x1 = data1.iloc[:, 0].values[: len(x1) // 3 * 3]
x1_0 = x1[0::3]
y1_0 = np.zeros(len(x1_0))
...
df_['parameter'] = r"$\epsilon$=0.15"
df = df.append(df_)
#######################

##########################
data1 = pd.read_csv('../plot_demo_files/return_related_to_clipcoef/0301_clipRun groupscleanrl_tau:0.9clip:0.2.csv')
x1 = data1.iloc[:, 0].values
x1 = data1.iloc[:, 0].values[: len(x1) // 3 * 3]
x1_0 = x1[0::3]
y1_0 = np.zeros(len(x1_0))
...
df_['parameter'] = r"$\epsilon$=0.2"
df = df.append(df_)
#######################

##########################
data1 = pd.read_csv('../plot_demo_files/return_related_to_clipcoef/0301_clipRun groupscleanrl_tau:0.9clip:0.25.csv')
x1 = data1.iloc[:, 0].values
x1 = data1.iloc[:, 0].values[: len(x1) // 3 * 3]
x1_0 = x1[0::3]
y1_0 = np.zeros(len(x1_0))
...
for i in [0.5]:
    ...
    plt.savefig(f'return_clip_coeff_3seed_{i}_64.pdf', dpi=300, bbox_inches='tight')
    # plt.show()
    plt.close()
haha=True
