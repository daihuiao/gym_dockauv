...
# 初始化流线图
stream = ax.streamplot(karmen_current.xx * position_scale, karmen_current.yy * position_scale,
                       karmen_current.U, karmen_current.V, density=1, linewidth=1, arrowsize=1, color='r')
